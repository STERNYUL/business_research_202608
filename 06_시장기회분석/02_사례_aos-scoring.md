...
>
> ✅ **그 점검을 수행했습니다 → [05_검토_Pain-분할-점검.md](05_검토_Pain-분할-점검.md)**
>
> | ID | 분할 축 | 통합 AOS | 분할 후 |
> |---|---|---:|---|
> | **PS-1** | 종목 유동성 | 3.0 | **2.0 / 4.0** — 알트·저유동성이 **공동 1위로 등장** |
> | **KD-1** | 자산 규모 | 1.8 | **1.6 / 2.4** — 소형 90개(69%)가 실제 기회 |
> | **BS-1** *(점검 중 신규 발견)* | 딜 규모 | 2.4 | **0.6 / 2.4** — 대형 딜은 **DOS 음수** |
>
> **18종 중 4종(22%)이 이 구조였고, 분할하면 한쪽이 거의 항상 과잉충족으로 나옵니다.** 예외가 아니라 체계적 문제이므로 [문항지에 분할 축을 직접 묻는 문항 3개를 추가](05_검토_Pain-분할-점검.md)했습니다.
