...
## 7. 갱신 — STO 축 승격, 남기훈 재판정, 온투업 명시

> **§1~§6은 원형 보존입니다.** 아래 셋이 이후 분석으로 바뀐 부분입니다.

### 7-1. STO가 "확장 후보"에서 "제3제품"으로 올라갑니다

§1의 제품 구조가 둘에서 셋이 됩니다.

```
Institutional Valuation Infrastructure
   ├── CRE Valuation API                  (상업용 부동산 — 평가 지연)
   ├── Digital Asset Reference Price API  (디지털 자산 — 가격 신뢰)
   └── STO 기초자산 Valuation             (조각투자·토큰증권 — 이해상충)   ← 승격
```

| | 상업용 부동산 | 디지털 자산 | **STO** |
|---|---|---|---|
| **핵심 문제** | 평가 지연 | 가격 신뢰성 | **이해상충** |
| 왜 생기나 | 거래가 드묾 | 시장 분산·24/7 | **발행자가 자기 상품 가치를 매김** |
| 평가 주기 | 월 / 분기 | 초 ~ 일 | **제도가 정함 — 미확정** |
| 핵심 고객 | AMC · 증권사 · 은행 | 거래소 · 수탁 | **증권사 STO 진영 · 발행사** |
| 대체재 강도 | ★★★★★ | ★★★☆☆ | **★★☆☆☆ — 제도로 금지** |
| 승부처 | 문서 *(보안·감사·품의)* | 가동률 *(SLA·폴백)* | **제도 *(요건 정의 참여)*** |
| 현 단계 | MVP 주력 | MVP 주력 | **요건 정의 참여** |

**§3의 Tier 3 판단이 확인됐습니다** — *"Tier 3(증권사·STO·RWA)가 장기적으로 가장 중요합니다. 3~5년 후 비중이 커질 세그먼트입니다."* **전자증권법 2027.2.4 시행으로 그 시점이 확정**됐습니다. 다만 [SAM은 아직 미산정](01_TAM-SAM-SOM_산정.md)입니다.

> 🔴 **§6-④의 교훈이 세 번째 축에도 적용됩니다** — *"같은 제품처럼 보여도 문제가 다르면 나눠라."* STO는 부동산·디지털과 문제(이해상충)·승부처(제도)가 모두 달라 **세 번째 제품으로 분리**해야 합니다. 기초자산이 부동산이어도 CRE API와 같은 제품이 아닙니다 — **파는 것이 값이 아니라 "제3자가 산정했다는 사실"** 이기 때문입니다.

### 7-2. 남기훈(NPL) 세그먼트 재판정

§2의 고객 우선순위 표에 NPL은 없었고, [편입 검토](../../05_페르소나/06_검토_NPL-기업부동산-편입.md)로 핵심에 추가됐다가 **다시 내려왔습니다.**

| | 편입 검토 | **재판정** |
|---|---|---|
| 유형 | 🔵 핵심 | 🟢 **확장 — 간접 채널** |
| 계약단가 | 8,000만 | **2,500만** *(WTP 상한 확인)* |
| 세그먼트 매출 | 6.4억 | **2.0억** |
| 직접 영업 | ⭕ | **✕ 제외** — 백서현 NPL 딜 템플릿으로 흡수 |

> 💡 **§6-①의 교훈이 반증 방향으로 재확인됩니다** — *"고객 수보다 확장 계수를 보라."* NPL은 확장 계수가 ◎(풀 1건 → 담보물 수백 건)인데도 실패했습니다. **확장 계수가 좋아도 ARPU 체력이 없으면 안 됩니다.** 상세: [세그먼트 재판정](../../08_value-proposition/01_검토_남기훈-세그먼트-재판정.md)

### 7-3. 온투업 명시 — §2 3차 계층 갱신

[온투업 검토가 *"지금 당장 할 수 있는 것 — 문서만 고치면 됩니다"*](../../05_페르소나/04_검토_온투업-동산P2P-편입.md) 라고 남긴 항목입니다.

| 계층 | 대상 *(갱신)* |
|---|---|
| **1차** | 리츠 AMC · 부동산 자산운용사 · 부동산신탁사 · 증권사 부동산금융 · 부동산 펀드 운용사 |
| **2차** | 은행 · 보험사 · 저축은행 · 캐피탈 · 기관투자자 · **회계법인** |
| **3차** | 부동산 플랫폼 · 조각투자·STO 사업자 · 부동산 유동화 플랫폼 · **온투업(부동산 담보·PF)** ← 명시 |
| *(제외)* | 일반 부동산 보유자 · **기업 부동산 자산관리팀** · **동산담보 P2P** *(PMF 이후)* |

**온투업 부동산 담보·PF는 새 시장이 아니라 3차 계층에 이미 포함돼 있던 것**입니다. 이름이 빠져 있어 별도 시장으로 오인될 수 있었습니다.

### 7-4. 이 갱신에서 배울 점

**① 세그먼트 맵은 한 번 그리고 끝나지 않습니다.**
이 문서가 그린 2제품 구조가 **3제품**이 됐고, 고객 계층에 회계법인·온투업이 추가됐고, NPL은 편입 후 재판정으로 내려왔습니다. **맵은 산출물이 아니라 갱신 대상**입니다.

**② "확장 후보"의 승격 조건은 시장 크기가 아니라 제도였습니다.**
STO를 §3에서 *"3~5년 후"* 로 미뤄뒀는데, 승격을 만든 것은 시장 성장이 아니라 **법 시행일 확정**입니다. 제도 산업에서는 **타임라인이 시장 규모보다 먼저 움직입니다.**

**③ 편입 검토와 판정 조건을 교차 확인해야 합니다.**
NPL 편입은 6축 자체 기준으로 통과했지만 **[사업성 판정 조건 1(규제·사건 트리거)](../../01_porters-five-forces/08_검토_사업성-판정.md)에는 걸렸습니다.** 새 프레임으로 채점할 때 기존 프레임의 결론과 충돌하는지 봐야 합니다.
