...
동일한 "가치평가 인프라" 모델을 적용할 수 있는 시장으로 검토된 영역입니다.
...
가격 결정 변수: 작가, 제작연도, 크기, 재료, 상태, provenance, 전시 이력, 소장 이력, 경매 이력.

> ⚠️ **포지셔닝 주의**: "미술품 감정 서비스"로 가면 시장이 작고 경쟁이 많습니다. **"미술품의 현재 시장가치를 지속 산출하는 Valuation Data/API"** 로 가야 다른 사업이 됩니다. 부동산·디지털 자산과 동일한 논리입니다.
