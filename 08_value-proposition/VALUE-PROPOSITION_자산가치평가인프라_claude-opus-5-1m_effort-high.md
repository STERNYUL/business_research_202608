...
| **F17** 이상치·차이 리포트 (20%+ 괴리만) | **조현우**(회계법인 감사, 1차 수혜자) · NG-1b(파생) · O2 | **4** | 3 | **✖** | **Mid** |
...
| **NG-1 분할의 파급** | 하나의 Pain에 만족도가 두 개인 구조가 남기훈에만 있다고 볼 근거가 없습니다. **KD-1도 자산 유형별로 갈릴 가능성**이 있어 같은 점검이 필요합니다 |
